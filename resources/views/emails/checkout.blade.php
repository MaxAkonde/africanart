...
<head>
    <title>African Art - Résumer de votre commande</title>
    <meta name="description" content="Résumer de votre commande." />
...
<body
    style="height: 100%; margin: 0; padding: 0; width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #ededed;">
    <center>
        <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%"
            id="bodyTable"
            style="border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; height: 100%; margin: 0; padding: 0; width: 100%; background-color: #ededed;">
            <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer"
                        ...
                        <tr>
                            <td valign="top" id="templatePreheader"
                                style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #ffffff; border-top: 0; border-bottom: 0; padding-top: 0px; padding-bottom: 0px;">
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" id="templateHeader"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="CodeBlock"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="mobile-hide mobile-no-padding text-padding-left" width="450"
                                                height="110" align="left"
                                                ...
                                                <a href="https://themes.email/" target="_blank"
                                                    style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; color: #111111; mso-line-height-rule: exactly; font-weight: normal; text-decoration: underline;"><img
                                                        src="https://s3.amazonaws.com/templates.themes.email/2022/cube/logo.png"
                                                        alt="Themes Email" width="120" height="20"
                                                        ...
                                                        data-pagespeed-url-hash="2761749788"
                                                        onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></a>
                                            </td>
                                            <td class="mobile-no-padding text-padding-right" height="110"
                                                width="180" align="right"
                                                style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt; padding-right: 58px; mso-line-height-rule: exactly;">
                                                <a href="https://themes.email/" target="_blank"
                                                    style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; color: #111111; mso-line-height-rule: exactly; font-weight: normal; text-decoration: underline;">
                                                    <img alt="Themes.email" width="26" height="20" border="0"
                                                        src="https://s3.amazonaws.com/templates.themes.email/2022/cube/icon.png"
                                                        style="padding-top: 3px; -ms-interpolation-mode: bicubic; border: 0; height: auto; line-height: 100%; outline: none; text-decoration: none; display: inline-block; font-size: 13px; font-weight: bold; text-transform: capitalize; vertical-align: middle; margin-right: 10px;"
                                                        data-pagespeed-url-hash="2426473494"
                                                        onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td id="emailcontent"
                                                                                ...
                                                                                <p
                                                                                    ...
                                                                                    Bonjour
                                                                                    {{ $data['order']['lname'] }} <br>
                                                                                    Merci pour votre commande. Elle est
                                                                                    en attente jusqu'a ce que nous
                                                                                    confirmons que le paiement ait bien
                                                                                    été bien reçu. En
                                                                                    attendant, voici un rappel de votre
                                                                                    commande
                                                                                </p>
                                                                                ...
                                                                                <h2
                                                                                    ...
                                                                                    Commande N° {{ $data['pincode'] }}
                                                                                    ({{ $data['order']['created_at']->format('j F, Y H:i') }})
                                                                                </h2>
                                                                                    ...
                                                                                    <table class="td"
                                                                                        ...
                                                                                        <thead>
                                                                                            <tr>
                                                                                                <th class="td"
                                                                                                    scope="col"
                                                                                                    style="text-align: left; color: #4e4e4e; vertical-align: middle; border-bottom: 1px solid #ebebeb;">
                                                                                                    Produit(s)</th>
                                                                                                <th class="td"
                                                                                                    scope="col"
                                                                                                    style="text-align: left; color: #4e4e4e; vertical-align: middle; border-bottom: 1px solid #ebebeb;">
                                                                                ...
                                                                                <table id="addresses" cellspacing="0"
                                                                                    cellpadding="0"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="text-align: left; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; padding: 0; mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;"
                                                                                            valign="top"
                                                                                            width="50%">
                                                                                            <h2
                                                                                                style="color: #656565; display: block; font-family: Helvetica; font-size: 18px; font-weight: bold; line-height: 125%; margin: 15px 0 10px 0; text-align: left; font-style: normal; letter-spacing: normal;">
                                                                ...
                                                                <div style="text-align: center;">
                                                                    <span style="font-size: 9px;">
                                                                        <span
                                                                            ...
                                                                            <strong>
                                                                                <a href="https://themes.email/magento.html"
                                                                                    target="_blank"
                                                                                    style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #656565; font-weight: bold; text-decoration: none;">MAGENTO</a>
                                                                                •
                                                                                <a href="https://themes.email/prestashop.html"
                                                                                    target="_blank"
                                                                                    style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #656565; font-weight: bold; text-decoration: none;">PRESTASHOP</a>
                                                                                •
                                                                                <a href="https://themes.email/woocommerce.html"
                                                                                    target="_blank"
                                                                                    style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #656565; font-weight: bold; text-decoration: none;">WOOCOMMERCE</a>
                                                                            </strong>
                                                                        </span>
                                                                    </span>
                                                                    <br>
                                                                    Themes.Email, Inc. 725 First Avenue, Sunnyvale, CA
                                                                    94089
                                                                </div>
                                                            </td>
                                                        </tr>
