                ...
                <div class="col-sm-4">
                    <div class="page-header float-left">
                        <div class="page-title">
                            <h1><small>{{ $payment->name }}</small></h1>
                        </div>
                    </div>
                </div>
                <div class="col-sm-8">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="{{ route('admin.payments.update', $payment->id) }}" method="post" class="">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" placeholder="Mobile Money" name="name"
                                value="{{ $payment->name }}" class="form-control @error('name') is-invalid @enderror"
