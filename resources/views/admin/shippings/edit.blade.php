...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <h4 class="title">Modifier {{ $shipping->name }}</h4>
                </div>
                <div class="content">
                    <form action="{{ route('admin.shippings.update', $shipping->id) }}" method="post" class="">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" placeholder="Entrer l'intituler" name="name"
                                value="{{ $shipping->name }}" class="form-control @error('name') is-invalid @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <select name="country_id" id="country_id"
                                ...
                                @foreach ($countries as $countrie)
                                    <option value="{{ $countrie->id }}" @if ($countrie->id === $shipping->country_id) selected @endif>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="price" placeholder="Entrer le prix" name="price"
                                value="{{ $shipping->price }}" class="form-control @error('price') is-invalid @enderror"
